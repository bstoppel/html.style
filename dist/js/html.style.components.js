...
var zt=0,R=class extends HTMLElement{static observedAttributes=["exclusive"];#t="";#e=null;connectedCallback(){this.#t||(this.#t=`hs-accordion-${++zt}`),this.#e=new MutationObserver(()=>this.#i()),this.#e.observe(this,{childList:!0}),this.addEventListener("toggle",this.#s,!0),this.#i()}disconnectedCallback(){this.#e?.disconnect(),this.#e=null,this.removeEventListener("toggle",this.#s,!0)}attributeChangedCallback(){this.isConnected&&this.#i()}get panels(){return[...this.querySelectorAll(":scope > details")]}openAll(){if(!this.hasAttribute("exclusive"))for(let t of this.panels)t.open=!0}closeAll(){for(let t of this.panels)t.open=!1}#i(){let t=this.hasAttribute("exclusive");for(let e of this.panels)t?e.setAttribute("name",this.#t):e.getAttribute("name")===this.#t&&e.removeAttribute("name")}#s=t=>{let e=t.target;e.parentElement===this&&this.dispatchEvent(new CustomEvent("hs-accordion-toggle",{bubbles:!0,detail:{index:this.panels.indexOf(e),open:e.open}}))}};customElements.define("hs-accordion",R);var Bt="Dismiss",D=class extends HTMLElement{static observedAttributes=["dismissible","dismiss-label"];connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","alert"),this.#t()}attributeChangedCallback(){this.isConnected&&this.#t()}#t(){let t=this.querySelector(":scope > [data-hs-dismiss]");if(!this.hasAttribute("dismissible")){t?.remove();return}let e=this.getAttribute("dismiss-label")||Bt;if(t){t.setAttribute("aria-label",e);return}let s=document.createElement("button");s.type="button",s.setAttribute("data-hs-dismiss",""),s.setAttribute("aria-label",e),s.textContent="\xD7",s.addEventListener("click",()=>this.dismiss()),this.append(s)}dismiss(){this.dispatchEvent(new CustomEvent("hs-dismiss",{bubbles:!0,cancelable:!0}))&&this.remove()}};customElements.define("hs-alert",D);var O=class extends HTMLElement{};customElements.define("hs-badge",O);var N=class extends HTMLElement{};customElements.define("hs-card",N);var z=globalThis,B=z.ShadowRoot&&(z.ShadyCSS===void 0||z.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,rt=Symbol(),vt=new WeakMap,w=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==rt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(B&&t===void 0){let s=e!==void 0&&e.length===1;s&&(t=vt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&vt.set(e,t))}return t}toString(){return this.cssText}},gt=r=>new w(typeof r=="string"?r:r+"",void 0,rt),f=(r,...t)=>{let e=r.length===1?r[0]:t.reduce((s,i,o)=>s+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+r[o+1],r[0]);return new w(e,r,rt)},yt=(r,t)=>{if(B)r.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let s=document.createElement("style"),i=z.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=e.cssText,r.appendChild(s)}},ot=B?r=>r:r=>r instanceof CSSStyleSheet?(t=>{let e="";for(let s of t.cssRules)e+=s.cssText;return gt(e)})(r):r;var{is:It,defineProperty:qt,getOwnPropertyDescriptor:jt,getOwnPropertyNames:Ft,getOwnPropertySymbols:Vt,getPrototypeOf:Wt}=Object,I=globalThis,At=I.trustedTypes,Kt=At?At.emptyScript:"",Yt=I.reactiveElementPolyfillSupport,C=(r,t)=>r,nt={toAttribute(r,t){switch(t){case Boolean:r=r?Kt:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,t){let e=r;switch(t){case Boolean:e=r!==null;break;case Number:e=r===null?null:Number(r);break;case Object:case Array:try{e=JSON.parse(r)}catch{e=null}}return e}},Et=(r,t)=>!It(r,t),_t={attribute:!0,type:String,converter:nt,reflect:!1,useDefault:!1,hasChanged:Et};Symbol.metadata??=Symbol("metadata"),I.litPropertyMetadata??=new WeakMap;var v=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=_t){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let s=Symbol(),i=this.getPropertyDescriptor(t,s,e);i!==void 0&&qt(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){let{get:i,set:o}=jt(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get:i,set(n){let l=i?.call(this);o?.call(this,n),this.requestUpdate(t,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??_t}static _$Ei(){if(this.hasOwnProperty(C("elementProperties")))return;let t=Wt(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(C("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(C("properties"))){let e=this.properties,s=[...Ft(e),...Vt(e)];for(let i of s)this.createProperty(i,e[i])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[s,i]of e)this.elementProperties.set(s,i)}this._$Eh=new Map;for(let[e,s]of this.elementProperties){let i=this._$Eu(e,s);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let i of s)e.unshift(ot(i))}else t!==void 0&&e.push(ot(t));return e}static _$Eu(t,e){let s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return yt(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){let s=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,s);if(i!==void 0&&s.reflect===!0){let o=(s.converter?.toAttribute!==void 0?s.converter:nt).toAttribute(e,s.type);this._$Em=t,o==null?this.removeAttribute(i):this.setAttribute(i,o),this._$Em=null}}_$AK(t,e){let s=this.constructor,i=s._$Eh.get(t);if(i!==void 0&&this._$Em!==i){let o=s.getPropertyOptions(i),n=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:nt;this._$Em=i;let l=n.fromAttribute(e,o.type);this[i]=l??this._$Ej?.get(i)??l,this._$Em=null}}requestUpdate(t,e,s,i=!1,o){if(t!==void 0){let n=this.constructor;if(i===!1&&(o=this[t]),s??=n.getPropertyOptions(t),!((s.hasChanged??Et)(o,e)||s.useDefault&&s.reflect&&o===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,s))))return;this.C(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:i,wrapped:o},n){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),o!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),i===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,o]of this._$Ep)this[i]=o;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[i,o]of s){let{wrapped:n}=o,l=this[i];n!==!0||this._$AL.has(i)||l===void 0||this.C(i,void 0,o,l)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(e)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};v.elementStyles=[],v.shadowRootOptions={mode:"open"},v[C("elementProperties")]=new Map,v[C("finalized")]=new Map,Yt?.({ReactiveElement:v}),(I.reactiveElementVersions??=[]).push("2.1.2");var pt=globalThis,$t=r=>r,q=pt.trustedTypes,xt=q?q.createPolicy("lit-html",{createHTML:r=>r}):void 0,Lt="$lit$",y=`lit$${Math.random().toFixed(9).slice(2)}$`,Pt="?"+y,Gt=`<${Pt}>`,E=document,T=()=>E.createComment(""),L=r=>r===null||typeof r!="object"&&typeof r!="function",bt=Array.isArray,Jt=r=>bt(r)||typeof r?.[Symbol.iterator]=="function",at=`[ 	
\f\r]`,S=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,kt=/-->/g,wt=/>/g,A=RegExp(`>|${at}(?:([^\\s"'>=/]+)(${at}*=${at}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ct=/'/g,St=/"/g,Ht=/^(?:script|style|textarea|title)$/i,mt=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),p=mt(1),$e=mt(2),xe=mt(3),$=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),Tt=new WeakMap,_=E.createTreeWalker(E,129);function Mt(r,t){if(!bt(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return xt!==void 0?xt.createHTML(t):t}var Xt=(r,t)=>{let e=r.length-1,s=[],i,o=t===2?"<svg>":t===3?"<math>":"",n=S;for(let l=0;l<e;l++){let a=r[l],c,u,h=-1,m=0;for(;m<a.length&&(n.lastIndex=m,u=n.exec(a),u!==null);)m=n.lastIndex,n===S?u[1]==="!--"?n=kt:u[1]!==void 0?n=wt:u[2]!==void 0?(Ht.test(u[2])&&(i=RegExp("</"+u[2],"g")),n=A):u[3]!==void 0&&(n=A):n===A?u[0]===">"?(n=i??S,h=-1):u[1]===void 0?h=-2:(h=n.lastIndex-u[2].length,c=u[1],n=u[3]===void 0?A:u[3]==='"'?St:Ct):n===St||n===Ct?n=A:n===kt||n===wt?n=S:(n=A,i=void 0);let g=n===A&&r[l+1].startsWith("/>")?" ":"";o+=n===S?a+Gt:h>=0?(s.push(c),a.slice(0,h)+Lt+a.slice(h)+y+g):a+y+(h===-2?l:g)}return[Mt(r,o+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},P=class r{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,n=0,l=t.length-1,a=this.parts,[c,u]=Xt(t,e);if(this.el=r.createElement(c,s),_.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(i=_.nextNode())!==null&&a.length<l;){if(i.nodeType===1){if(i.hasAttributes())for(let h of i.getAttributeNames())if(h.endsWith(Lt)){let m=u[n++],g=i.getAttribute(h).split(y),U=/([.?@])?(.*)/.exec(m);a.push({type:1,index:o,name:U[2],strings:g,ctor:U[1]==="."?lt:U[1]==="?"?ct:U[1]==="@"?dt:k}),i.removeAttribute(h)}else h.startsWith(y)&&(a.push({type:6,index:o}),i.removeAttribute(h));if(Ht.test(i.tagName)){let h=i.textContent.split(y),m=h.length-1;if(m>0){i.textContent=q?q.emptyScript:"";for(let g=0;g<m;g++)i.append(h[g],T()),_.nextNode(),a.push({type:2,index:++o});i.append(h[m],T())}}}else if(i.nodeType===8)if(i.data===Pt)a.push({type:2,index:o});else{let h=-1;for(;(h=i.data.indexOf(y,h+1))!==-1;)a.push({type:7,index:o}),h+=y.length-1}o++}}static createElement(t,e){let s=E.createElement("template");return s.innerHTML=t,s}};function x(r,t,e=r,s){if(t===$)return t;let i=s!==void 0?e._$Co?.[s]:e._$Cl,o=L(t)?void 0:t._$litDirective$;return i?.constructor!==o&&(i?._$AO?.(!1),o===void 0?i=void 0:(i=new o(r),i._$AT(r,e,s)),s!==void 0?(e._$Co??=[])[s]=i:e._$Cl=i),i!==void 0&&(t=x(r,i._$AS(r,t.values),i,s)),t}var ht=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??E).importNode(e,!0);_.currentNode=i;let o=_.nextNode(),n=0,l=0,a=s[0];for(;a!==void 0;){if(n===a.index){let c;a.type===2?c=new H(o,o.nextSibling,this,t):a.type===1?c=new a.ctor(o,a.name,a.strings,this,t):a.type===6&&(c=new ut(o,this,t)),this._$AV.push(c),a=s[++l]}n!==a?.index&&(o=_.nextNode(),n++)}return _.currentNode=E,i}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},H=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=x(this,t,e),L(t)?t===d||t==null||t===""?(this._$AH!==d&&this._$AR(),this._$AH=d):t!==this._$AH&&t!==$&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Jt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==d&&L(this._$AH)?this._$AA.nextSibling.data=t:this.T(E.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,i=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=P.createElement(Mt(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{let o=new ht(i,this),n=o.u(this.options);o.p(e),this.T(n),this._$AH=o}}_$AC(t){let e=Tt.get(t.strings);return e===void 0&&Tt.set(t.strings,e=new P(t)),e}k(t){bt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,i=0;for(let o of t)i===e.length?e.push(s=new r(this.O(T()),this.O(T()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=$t(t).nextSibling;$t(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},k=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=d,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=d}_$AI(t,e=this,s,i){let o=this.strings,n=!1;if(o===void 0)t=x(this,t,e,0),n=!L(t)||t!==this._$AH&&t!==$,n&&(this._$AH=t);else{let l=t,a,c;for(t=o[0],a=0;a<o.length-1;a++)c=x(this,l[s+a],e,a),c===$&&(c=this._$AH[a]),n||=!L(c)||c!==this._$AH[a],c===d?t=d:t!==d&&(t+=(c??"")+o[a+1]),this._$AH[a]=c}n&&!i&&this.j(t)}j(t){t===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},lt=class extends k{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===d?void 0:t}},ct=class extends k{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==d)}},dt=class extends k{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=x(this,t,e,0)??d)===$)return;let s=this._$AH,i=t===d&&s!==d||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==d&&(s===d||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},ut=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){x(this,t)}};var Zt=pt.litHtmlPolyfillSupport;Zt?.(P,H),(pt.litHtmlVersions??=[]).push("3.3.3");var Ut=(r,t,e)=>{let s=e?.renderBefore??t,i=s._$litPart$;if(i===void 0){let o=e?.renderBefore??null;s._$litPart$=i=new H(t.insertBefore(T(),o),o,void 0,e??{})}return i._$AI(r),i};var ft=globalThis,b=class extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ut(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return $}};b._$litElement$=!0,b.finalized=!0,ft.litElementHydrateSupport?.({LitElement:b});var Qt=ft.litElementPolyfillSupport;Qt?.({LitElement:b});(ft.litElementVersions??=[]).push("4.2.2");var j=class extends HTMLElement{};customElements.get("hs-option")||customElements.define("hs-option",j);var F=class extends b{static formAssociated=!0;static properties={name:{type:String},value:{type:String,reflect:!0},label:{type:String},placeholder:{type:String},disabled:{type:Boolean,reflect:!0},open:{type:Boolean,reflect:!0},_query:{state:!0,attribute:!1},_active:{state:!0,attribute:!1},_options:{state:!0,attribute:!1}};static styles=f`
  ...
  `;#t;#e="";#i="";constructor(){super(),this.value="",this.label="",this.placeholder="",this.disabled=!1,this.open=!1,this._query=null,this._active=-1,this._options=[],this.#t=this.attachInternals()}connectedCallback(){super.connectedCallback(),this.#e=this.getAttribute("value")??"",this.#s(),this.#t.setFormValue(this.value||null)}#s(){this._options=[...this.querySelectorAll("hs-option")].map((t,e)=>({index:e,value:t.getAttribute("value")??t.textContent.trim(),text:t.textContent.trim()}))}get#r(){if(this._query===null||this._query==="")return this._options;let t=this._query.toLowerCase();return this._options.filter(e=>e.text.toLowerCase().includes(t))}get#o(){return this._query!==null?this._query:this._options.find(t=>t.value===this.value)?.text??""}willUpdate(){this.#t.setFormValue(this.value||null),this.#t.ariaDisabled=String(this.disabled),this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled")}#a(){this.open||this.disabled||(this.open=!0,this.dispatchEvent(new Event("hs-open",{bubbles:!0})))}#n(){this.open&&(this.open=!1,this._active=-1,this.dispatchEvent(new Event("hs-close",{bubbles:!0})))}#h=()=>{this.#i=this.value};#p=t=>{this._query=t.target.value,this._active=this.#r.length>0?this.#r[0].index:-1,this.#a()};#c=t=>{let e=this.#r,s=i=>e.findIndex(o=>o.index===i);switch(t.key){case"ArrowDown":case"ArrowUp":{if(t.preventDefault(),!this.open){this.#a(),e.length>0&&(this._active=e[0].index);return}if(e.length===0)return;let i=t.key==="ArrowDown"?1:-1,n=(s(this._active)+i+e.length)%e.length;this._active=e[n].index;return}case"Home":case"End":if(!this.open||e.length===0)return;t.preventDefault(),this._active=(t.key==="Home"?e[0]:e.at(-1)).index;return;case"Enter":{if(!this.open||this._active<0)return;t.preventDefault(),this.#b(this._active);return}case"Escape":if(!this.open)return;t.preventDefault(),this.#u();return;case"Tab":this.#l();return;default:}};#d=()=>this.#l();#l(){this._query=null,this.#n()}#u(){this._query=null,this.value!==this.#i&&(this.value=this.#i),this.#n()}#b(t){let e=this._options[t];if(!e||e.value===this.value){this.#l();return}this.value=e.value,this.#i=e.value,this._query=null,this.#n(),this.dispatchEvent(new Event("change",{bubbles:!0}))}formResetCallback(){this.value=this.#e,this._query=null,this.#n()}formStateRestoreCallback(t){this.value=t??""}refresh(){this.#s()}render(){let t=this.#r;return p`
    ...
    `}};customElements.define("hs-combobox",F);var te="Copied";var V=class extends HTMLElement{#t=null;#e=null;#i="";#s=0;connectedCallback(){this.#t||(this.#i=this.textContent.trim()||"Copy",this.#t=document.createElement("button"),this.#t.type="button",this.#t.textContent=this.#i,this.#t.addEventListener("click",()=>this.copy()),this.#e=document.createElement("span"),this.#e.className="visually-hidden",this.#e.setAttribute("role","status"),this.replaceChildren(this.#t,this.#e))}disconnectedCallback(){clearTimeout(this.#s)}get text(){let t=this.getAttribute("for");return t?document.getElementById(t)?.textContent??"":this.getAttribute("value")??""}async copy(){let t=this.text;if(t){try{await navigator.clipboard.writeText(t)}catch(e){this.dispatchEvent(new CustomEvent("hs-copy-error",{bubbles:!0,detail:{error:e}}));return}this.#r(),this.dispatchEvent(new CustomEvent("hs-copy",{bubbles:!0,detail:{text:t}}))}}#r(){let t=this.getAttribute("copied-label")||te;this.#e.textContent=t,this.setAttribute("data-copied",""),clearTimeout(this.#s),this.#s=setTimeout(()=>{this.removeAttribute("data-copied"),this.#e.textContent=""},2e3)}};customElements.define("hs-copy",V);var W=class r extends HTMLElement{static observedAttributes=["open","persistent"];static#t="closedBy"in HTMLDialogElement.prototype;#e=null;connectedCallback(){this.#e||(this.#e=document.createElement("dialog"),this.#e.append(...this.childNodes),this.append(this.#e),this.#e.addEventListener("close",this.#s),r.#t||this.#e.addEventListener("click",this.#r)),this.#i(),this.hasAttribute("open")&&this.show()}attributeChangedCallback(t,e,s){if(!(!this.isConnected||e===s)){if(t==="persistent"){this.#i();return}t==="open"&&(s===null?this.close():this.show())}}#i(){!r.#t||!this.#e||(this.#e.closedBy=this.hasAttribute("persistent")?"closerequest":"any")}get dialog(){return this.#e}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}show(){!this.#e||this.#e.open||(this.#e.showModal(),this.hasAttribute("open")||this.setAttribute("open",""),this.dispatchEvent(new CustomEvent("hs-open",{bubbles:!0})))}close(t){this.#e?.open&&this.#e.close(t)}#s=()=>{this.removeAttribute("open"),this.dispatchEvent(new CustomEvent("hs-close",{bubbles:!0,detail:{returnValue:this.#e.returnValue}}))};#r=t=>{if(this.hasAttribute("persistent")||t.target!==this.#e)return;let e=this.#e.getBoundingClientRect();t.clientX>=e.left&&t.clientX<=e.right&&t.clientY>=e.top&&t.clientY<=e.bottom||this.close("backdrop")}};customElements.define("hs-dialog",W);var ee=0,K=class extends HTMLElement{static observedAttributes=["label","hint"];#t=null;#e=null;#i=null;#s=null;#r="";connectedCallback(){this.#t=this.querySelector("input, select, textarea"),this.#t&&(this.#r||(this.#r=this.#t.id||`hs-field-${++ee}`),this.#t.id=this.#r,this.#o(),this.#a(),this.#n(),this.#h(),this.addEventListener("invalid",this.#d,!0),this.#t.addEventListener("blur",this.#l),this.#t.addEventListener("input",this.#u))}disconnectedCallback(){this.removeEventListener("invalid",this.#d,!0),this.#t?.removeEventListener("blur",this.#l),this.#t?.removeEventListener("input",this.#u)}attributeChangedCallback(){!this.isConnected||!this.#t||(this.#o(),this.#a(),this.#h())}get control(){return this.#t}#o(){let t=this.querySelector(":scope > label");if(t&&t!==this.#e){t.hasAttribute("for")||t.setAttribute("for",this.#r);return}let e=this.getAttribute("label");if(!e){this.#e?.remove(),this.#e=null;return}this.#e||(this.#e=document.createElement("label"),this.#t.before(this.#e)),this.#e.setAttribute("for",this.#r),this.#e.textContent=e}#a(){let t=this.getAttribute("hint");if(!t){this.#i?.remove(),this.#i=null;return}this.#i||(this.#i=document.createElement("p"),this.#i.id=`${this.#r}-hint`,this.#i.setAttribute("data-hs-hint",""),this.#t.after(this.#i)),this.#i.textContent=t}#n(){this.#s||(this.#s=document.createElement("p"),this.#s.id=`${this.#r}-error`,this.#s.setAttribute("data-hs-error",""),this.#s.setAttribute("role","alert"),this.#s.hidden=!0,(this.#i??this.#t).after(this.#s))}#h(){let t=[];this.#i&&t.push(this.#i.id),this.#s&&!this.#s.hidden&&t.push(this.#s.id);let e=new Set([`${this.#r}-hint`,`${this.#r}-error`]),i=[...(this.#t.getAttribute("aria-describedby")??"").split(/\s+/).filter(o=>o&&!e.has(o)),...t];i.length?this.#t.setAttribute("aria-describedby",i.join(" ")):this.#t.removeAttribute("aria-describedby")}#p(t){this.hasAttribute("novalidate")||(this.#s.textContent=t,this.#s.hidden=!1,this.#t.setAttribute("aria-invalid","true"),this.#h())}#c(){this.#s.hidden=!0,this.#s.textContent="",this.#t.removeAttribute("aria-invalid"),this.#h()}#d=t=>{t.target===this.#t&&(this.hasAttribute("novalidate")||(t.preventDefault(),this.#p(this.#t.validationMessage),this.dispatchEvent(new CustomEvent("hs-invalid",{bubbles:!0,detail:{message:this.#t.validationMessage}}))))};#l=()=>{this.hasAttribute("novalidate")||this.#t.value===""||this.#t.checkValidity()&&this.#c()};#u=()=>{!this.#s.hidden&&this.#t.checkValidity()&&this.#c()}};customElements.define("hs-field",K);var se=CSS.supports("position-anchor: --hs"),ie={"block-end start":"block-end span-inline-end","block-end end":"block-end span-inline-start","block-end center":"block-end span-all","block-start start":"block-start span-inline-end","block-start end":"block-start span-inline-start","block-start center":"block-start span-all"},re={"block-end":"block-start","block-start":"block-end",start:"end",end:"start"},M=new CSSStyleSheet;M.replaceSync(`
  [data-hs-anchored] {
    position: fixed;
...
`);function Nt(r){r.adoptedStyleSheets.includes(M)||(r.adoptedStyleSheets=[...r.adoptedStyleSheets,M])}var oe=0;function Y(r,t,e={}){let{placement:s="block-end",align:i="start",strategy:o="auto"}=e;return(o==="auto"?se:o==="declarative")?ne(r,t,s,i):he(r,t,s,i)}function ne(r,t,e,s){let i=`--hs-anchor-${++oe}`;return t.style.setProperty("anchor-name",i),r.style.setProperty("--hs-anchor-name",i),r.style.setProperty("--hs-anchor-area",ie[`${e} ${s}`]),r.dataset.hsAnchored="declarative",()=>{t.style.removeProperty("anchor-name"),r.style.removeProperty("--hs-anchor-name"),r.style.removeProperty("--hs-anchor-area"),delete r.dataset.hsAnchored}}var ae=["--hs-anchor-after","--hs-anchor-before","--hs-anchor-start","--hs-anchor-end","--hs-anchor-center"];function he(r,t,e,s){r.dataset.hsAnchored="script";let i=0,o=()=>{i||(i=requestAnimationFrame(()=>{i=0,Rt(r,t,e,s)}))};Rt(r,t,e,s);let n={capture:!0,passive:!0};document.addEventListener("scroll",o,n),window.addEventListener("resize",o,n);let l=new ResizeObserver(o);return l.observe(r),l.observe(t),()=>{cancelAnimationFrame(i),document.removeEventListener("scroll",o,n),window.removeEventListener("resize",o,n),l.disconnect();for(let a of ae)r.style.removeProperty(a);delete r.dataset.hsAnchored,delete r.dataset.hsPlacement,delete r.dataset.hsAlign}}function Rt(r,t,e,s){let i=t.getBoundingClientRect();if(i.width===0&&i.height===0)return;let o=document.documentElement,n=getComputedStyle(r).direction==="rtl";if(r.style.setProperty("--hs-anchor-after",`${i.bottom}px`),r.style.setProperty("--hs-anchor-before",`${o.clientHeight-i.top}px`),r.style.setProperty("--hs-anchor-start",`${n?o.clientWidth-i.right:i.left}px`),r.style.setProperty("--hs-anchor-end",`${n?i.left:o.clientWidth-i.right}px`),r.dataset.hsPlacement=Dt(r,"hsPlacement",e,"block"),s==="center"){r.dataset.hsAlign="center",le(r,i,o);return}r.dataset.hsAlign=Dt(r,"hsAlign",s,"inline")}function le(r,t,e){let s=(t.left+t.right)/2;r.style.setProperty("--hs-anchor-center",`${s}px`);let i=r.getBoundingClientRect(),o=i.right-e.clientWidth,n=-i.left;if(o>0)s-=o;else if(n>0)s+=n;else return;r.style.setProperty("--hs-anchor-center",`${s}px`)}function Dt(r,t,e,s){r.dataset[t]=e;let i=Ot(r,s);if(i===0)return e;let o=re[e];return r.dataset[t]=o,Ot(r,s)<i?o:e}function Ot(r,t){let e=r.getBoundingClientRect(),s=document.documentElement,[i,o,n]=t==="block"?[e.top,e.bottom,s.clientHeight]:[e.left,e.right,s.clientWidth];return Math.max(0,-i)+Math.max(0,o-n)}var G=class extends HTMLElement{};customElements.get("hs-menu-item")||customElements.define("hs-menu-item",G);var ce=500,de=r=>r.key.length===1&&r.key!==" "&&!r.ctrlKey&&!r.metaKey&&!r.altKey,J=class extends b{static properties={label:{type:String},disabled:{type:Boolean,reflect:!0},open:{type:Boolean,reflect:!0},_items:{state:!0,attribute:!1},_active:{state:!0,attribute:!1}};static styles=[M,f`
    ...
    `];#t=null;#e=0;#i=!1;#s="";#r=0;constructor(){super(),this.label="",this.disabled=!1,this.open=!1,this._items=[],this._active=0}connectedCallback(){super.connectedCallback(),this.#n()}disconnectedCallback(){super.disconnectedCallback(),this.#t?.(),this.#t=null,clearTimeout(this.#r)}get#o(){return this.renderRoot?.querySelector('[part="menu"]')}get#a(){return this.renderRoot?.querySelector('[part="trigger"]')}#n(){this._items=[...this.querySelectorAll(":scope > hs-menu-item")].map((t,e)=>({index:e,value:t.getAttribute("value")??t.textContent.trim(),label:t.textContent.trim()})),this._active>=this._items.length&&(this._active=0)}refresh(){this.#n()}updated(t){!t.has("open")||!this.#o||this.open!==this.#i&&(this.#i=this.open,this.open?this.#o.showPopover():this.#o.hidePopover())}#h=t=>{this.#i=t.newState==="open",this.open=this.#i};#p=t=>{t.newState==="open"?this.#c():this.#d()};#c(){this.#t=Y(this.#o,this.#a,{placement:"block-end",align:"start"}),this.#l(this.#e),this.dispatchEvent(new Event("hs-open",{bubbles:!0}))}#d(){this.#t?.(),this.#t=null,this.#e=0,this.#s="",(this.#o.contains(this.renderRoot.activeElement)||document.activeElement===document.body)&&this.#a?.focus(),this.dispatchEvent(new Event("hs-close",{bubbles:!0}))}#l(t){let e=this._items.length;e!==0&&(this._active=(t+e)%e,this.updateComplete.then(()=>{this.renderRoot.querySelectorAll('[part="item"]')[this._active]?.focus()}))}#u=t=>{t.key!=="ArrowDown"&&t.key!=="ArrowUp"||this.open||(t.preventDefault(),this.#e=t.key==="ArrowDown"?0:this._items.length-1,this.#o.showPopover())};#b=t=>{switch(t.key){case"ArrowDown":t.preventDefault(),this.#l(this._active+1);return;case"ArrowUp":t.preventDefault(),this.#l(this._active-1);return;case"Home":t.preventDefault(),this.#l(0);return;case"End":t.preventDefault(),this.#l(this._items.length-1);return;case"Tab":this.#o.hidePopover();return;case"Escape":return;default:}de(t)&&(t.preventDefault(),this.#m(t.key))};#m(t){clearTimeout(this.#r),this.#r=setTimeout(()=>{this.#s=""},ce),this.#s+=t.toLowerCase();let e=this._items.length,s=this.#s.length===1?this._active+1:this._active;for(let i=0;i<e;i++){let o=(s+i)%e;if(this._items[o].label.toLowerCase().startsWith(this.#s)){this.#l(o);return}}}#f(t){let e=this._items[t];e&&(this.dispatchEvent(new CustomEvent("hs-menu-select",{bubbles:!0,detail:{value:e.value,label:e.label,index:t}})),this.#o.hidePopover())}render(){return p`
      <button
        part="trigger"
        id="trigger"
        type="button"
    ...
    `}};customElements.define("hs-menu",J);var X=class extends HTMLElement{};customElements.get("hs-tab-panel")||customElements.define("hs-tab-panel",X);var Z=class extends b{static properties={selected:{type:Number,reflect:!0},activation:{type:String,reflect:!0},_labels:{state:!0,attribute:!1}};static styles=f`
  ...
  `;#t;#e=!1;constructor(){super(),this.checked=!1,this.disabled=!1,this.value="on",this.#t=this.attachInternals(),this.#t.role="switch"}connectedCallback(){super.connectedCallback(),this.#e=this.hasAttribute("checked"),this.#t.setFormValue(this.checked?this.value:null),this.hasAttribute("tabindex")||(this.tabIndex=this.disabled?-1:0),this.addEventListener("click",this.#i),this.addEventListener("keydown",this.#s)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.#i),this.removeEventListener("keydown",this.#s)}willUpdate(){this.#t.ariaChecked=String(this.checked),this.#t.ariaDisabled=String(this.disabled),this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"),this.#t.setFormValue(this.checked?this.value:null),(!this.hasAttribute("tabindex")||this.tabIndex>=0||this.disabled)&&(this.tabIndex=this.disabled?-1:0)}#i=()=>this.toggle();#s=t=>{t.key!==" "&&t.key!=="Enter"||(t.preventDefault(),this.toggle())};toggle(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("change",{bubbles:!0})))}formResetCallback(){this.checked=this.#e}formStateRestoreCallback(t){this.checked=t!==null}render(){return p`
      ...
      <slot></slot>
    `}};customElements.define("hs-toggle",it);export{R as HsAccordion,D as HsAlert,O as HsBadge,N as HsCard,F as HsCombobox,V as HsCopy,W as HsDialog,K as HsField,J as HsMenu,G as HsMenuItem,j as HsOption,X as HsTabPanel,Z as HsTabs,st as HsThemeToggle,Q as HsToast,tt as HsToastRegion,it as HsToggle,et as HsTooltip};
